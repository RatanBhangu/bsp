        ...
        <div class="card border-left-primary shadow h-100 py-2">
          <div class="card-body">
            ...
            <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\User::countUsers()}}</div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Product::countProduct()}}</div>
              </div>
              <div class="col-auto">
